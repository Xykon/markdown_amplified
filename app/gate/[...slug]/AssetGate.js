...
export default function AssetGate({ relPath, filename, encrypted, validFrom, validUntil, homeUrl, cookieConfig, siteName, siteBanner, siteBannerLight, siteBannerDark, githubUrl, siteButton }) {
  ...
  const header = <Header slug={null} hasToc={false} homeUrl={homeUrl} siteName={siteName} siteBanner={siteBanner} siteBannerLight={siteBannerLight} siteBannerDark={siteBannerDark} githubUrl={githubUrl} siteButton={siteButton} />
